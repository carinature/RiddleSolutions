...
# return True if targetSum can be constructed from any combination of array numbers (all positive)
#
...
# def CanSum(targetSum: int, arr: List[int]) -> bool:
#     # Tnai Azira
#     if 0 == targetSum:
#         return True
#     if 0 > targetSum:
...
# the height of the tree is the number of time we can subtract a number from the array of targetSum.
# so worst case scenario we subtract 1 from targetSum each step
