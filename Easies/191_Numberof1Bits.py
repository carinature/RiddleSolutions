...
# Output: 1
# Explanation:
#   The input binary string 00000000000000000000000010000000
...
def testing():
    print("--------------------------------")
    result = some_function(n=0b0000000000000000000000000001011)
    print(f"result: {result}")
    assert (3 == result)

    result = some_function(n=0b00000000000000000000000010000000)
    print(f"result: {result}")
    assert (1 == result)

    result = some_function(n=0b11111111111111111111111111111101)
    print(f"result: {result}")
    assert (31 == result)
...
if __name__ == '__main__':
    print("\n Finished in --- %.5f seconds ---" %
          (timeit.timeit(testing, number=100000)))
