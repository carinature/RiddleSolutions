...
#
#
# todo    Follow up: Could you find an O(nums1.length + nums2.length) solution?
#
#
...
def testing():
    ...
    result = nextGreaterElement(nums1=[2, 4], nums2=[1, 2, 3, 4])
    # print(f"result: {result}")
    assert ([3, -1] == result)

    # result = nextGreaterElement(nums1=124356)
    # # print(f"result: {result}")
